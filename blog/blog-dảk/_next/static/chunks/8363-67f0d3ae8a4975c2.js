    ...
    [8363], {
        ...
        58517: function(e, t, n) {
            ...
            var T = function(e) {
                ...
                function w(e) {
                    ...
                    ! function(e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, w), _(O(t = v.call(this, e)), "listRefHandler", (function(e) {
                        return t.list = e
                        ...
                        value: function() {
                            ...
                            for (var s = [], l = null, c = 0; c < o.length; c += e.rows * e.slidesPerRow) {
                                for (var d = [], p = c; p < c + e.rows * e.slidesPerRow; p += e.slidesPerRow) {
                                    for (var h = [], y = p; y < p + e.slidesPerRow && (e.variableWidth && o[y].props.style && (l = o[y].props.style.width), !(y >= o.length)); y += 1) h.push(r.default.cloneElement(o[y], {
                                        key: 100 * c + 10 * p + y,
                                        tabIndex: -1,
                                        style: {
        ...
        15518: function(e, t, n) {
            ...
            t.slideHandler = function(e) {
                ...
                if (r) {
                    if (!i && (o < 0 || o >= s)) return {};
                    o < 0 ? w = o + s : o >= s && (w = o - s), c && v.indexOf(w) < 0 && (v = v.concat(w)), O = {
                        animating: !0,
                        currentSlide: w,
                        lazyLoadedList: v,
                        targetSlide: w
                    ...
                    slideIndex: b
                })), i || (m === S && (w = b), m = S), c && (v = v.concat(u(a(a({}, e), {}, {
                    currentSlide: w
                })))), y ? (O = {
                    animating: !0,
                    currentSlide: b,
            ...
            t.swipeMove = function(e, t) {
                ...
                if (!n) {
                    ...
                    var M = Math.ceil(v / m),
                        R = b(t.touchObject, s),
                        z = w.swipeLength;
                    return S || (0 === u && ("right" === R || "down" === R) || u + 1 >= M && ("left" === R || "up" === R) || !g(t) && ("left" === R || "up" === R)) && (z = w.swipeLength * d, !1 === f && p && (p(R), E.edgeDragged = !0)), !h && O && (O(R), E.swiped = !0), j = i ? x + z * (_ / P) * C : l ? x - z * C : x + z * C, s && (j = x + z * C), E = a(a({}, E), {}, {
                        touchObject: w,
                        swipeLeft: j,
                        trackStyle: k(a(a({}, t), {}, {
                            left: j
                        }))
                    }), Math.abs(w.curX - w.startX) < .8 * Math.abs(w.curY - w.startY) ? E : (w.swipeLength > 10 && (E.swiping = !0, c(e)), E)
                }
            };
            t.swipeEnd = function(e, t) {
                ...
                if (i.swipeLength > g) {
                    ...
                    switch (m) {
                        case "left":
                        case "up":
                            P = j + w(t), k = d ? S(t, P) : P, O.currentDirection = 0;
                            break;
                        case "right":
                        case "down":
                            P = j - w(t), k = d ? S(t, P) : P, O.currentDirection = 1;
                            break;
                        default:
                            k = j
                    }
            ...
            var T = function(e) {
                ...
                var v = 0;
                if (o ? (v = -P(e), s % c !== 0 && r + c > s && (v = -(r > s ? l - (r - s) : s % c)), a && (v += parseInt(l / 2))) : (s % c !== 0 && r + c > s && (v = l - s % c), a && (v = parseInt(l / 2))), t = y ? r * p * -1 + v * p : r * u * -1 + v * u, !0 === f) {
                    var b, g = i && i.node;
