(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [6147], {
                    ...
                    function t(t, e, n) {
                        ...
                        this.target = t, this.endVal = e, this.options = n, this.version = "2.0.8", this.defaults = {
                            ...
                            if (n = s[0], r = s.length > 1 ? i.options.decimal + s[1] : "", i.options.useGrouping) {
                                o = "";
                                for (var u = 0, l = n.length; u < l; ++u) 0 !== u && u % 3 == 0 && (o = i.options.separator + o), o = n[l - u - 1] + o;
                                n = o
                            }
        ...
        17857: function(t, e, n) {
            ...
            var d = ["ref", "startOnMount", "enableReinitialize", "delay", "onEnd", "onStart", "onPauseResume", "onReset", "onUpdate"],
                m = {
                    decimal: ".",
                    delay: null,
                    prefix: "",
                ...
                b = function(t) {
                    var e = r.useMemo((function() {
                        ...
                        C = h((function() {
                            ...
                            s && s > 0 ? V.current = setTimeout(t, 1e3 * s) : t(), null === c || void 0 === c || c({
                                pauseResume: T,
                                reset: k,
                                update: P
                            })
                        ...
                        T = h((function() {
                            w().pauseResume(), null === p || void 0 === p || p({
                                reset: k,
                                start: R,
                                update: P
                            })
                        ...
                        k = h((function() {
                            V.current && clearTimeout(V.current), w().reset(), null === b || void 0 === b || b({
                                pauseResume: T,
                                start: R,
                                update: P
                            })
                    ...
                    return r.useEffect((function() {
                        O.current ? a && j(!0) : (O.current = !0, j())
                    }), [a, O, j, s, t.start, t.suffix, t.prefix, t.duration, t.separator, t.decimals, t.decimal, t.formattingFn]), r.useEffect((function() {
                        return function() {
                            k()
                        }
                    }), [k]), {
            ...
            e.ZP = function(t) {
                var e = t.className,
                    ...
                    C = h((function(e) {
                        t.preserveValue || v(), V(e)
                    })),
                    T = h((function() {
                        "function" !== typeof t.children || p.current instanceof Element ? E() : console.error('Couldn\'t find attached element to hook the CountUp instance into! Try to attach "containerRef" from the render prop to a an Element, eg. <span ref={containerRef} />.')
                    }));
                ...
                return r.useEffect((function() {
                    n && d.current && w()
                }), [w, n, k]), r.useEffect((function() {
                    !n && d.current && w()
                }), [w, n, t.start, t.suffix, t.prefix, t.duration, t.separator, t.decimals, t.decimal, t.className, t.formattingFn]), r.useEffect((function() {
                    d.current = !0
                }), []), "function" === typeof o ? o({
                    countUpRef: p,
                    start: g,
                    ...
                    ref: p,
                    style: s
                }, i), t.start ? E().formattingFn(t.start) : "")
            }
        },
        33082: function(t, e, n) {
            var r;
            r = function(t, e) {
                return function(t) {
                    var e = {};
                    ...
                    t.exports = function(t, e, n) {
                        ...
                        switch (r) {
                            case "top":
                                return n.top + i < e.top && n.bottom > e.bottom && n.left < e.left && n.right > e.right;
                            case "left":
                                return n.left + i < e.left && n.bottom > e.bottom && n.top < e.top && n.right > e.right;
                            case "bottom":
                                return n.bottom - i > e.bottom && n.left < e.left && n.right > e.right && n.top < e.top;
                            case "right":
                                return n.right - i > e.right && n.left < e.left && n.top < e.top && n.bottom > e.bottom
                        }
                    }
                }, function(t, e, n) {
                    "use strict";
                    ...
                    var y = function(t) {
                        function e(t) {
                            ...
                            return function(t, e) {
                                ...
                                return !e || "object" !== f(e) && "function" !== typeof e ? d(t) : e
                            }(this, h(e).call(this, t)), b(d(n), "getContainer", (function() {
                                return n.props.containment || window
                            })), b(d(n), "addEventListener", (function(t, e, r, i) {
                                var o;
                                ...
                                "object" === f(o) && (e.top += o.top || 0, e.left += o.left || 0, e.bottom -= o.bottom || 0, e.right -= o.right || 0);
                                var a = {
                                        top: t.top >= e.top,
                                        left: t.left >= e.left,
                                ...
                                "string" === typeof o.direction && "number" === typeof o.value && (console.warn("[notice] offset.direction and offset.value have been deprecated. They still work for now, but will be removed in next major version. Please upgrade to the new syntax: { %s: %d }", o.direction, o.value), u = c()(o, t, e));
                                var p = n.state;
